...
function thinkup_customizer_theme_options( $wp_customize ) {
	...
	$wp_customize->add_section(
		new thinkup_customizer_customswitch_button_link(
			...
			array(
				'title'        => esc_html__( 'Sento Pro', 'sento' ),
				'priority'     => 1,
				'button_text' => esc_html__( 'Upgrade Now', 'sento' ),
				'button_url'  => 'https://www.thinkupthemes.com/themes/sento/',
	...
	$wp_customize->add_section(
		new thinkup_customizer_customswitch_button_link(
			...
			array(
				'title'        => esc_html__( 'Documentation', 'sento' ),
				'priority'     => 1,
				'button_text' => __( 'View Docs', 'sento' ),
	...
	$wp_customize->add_panel(
		...
		array(
			'title'       => esc_html__( 'Theme Options', 'sento' ),
			'description' => esc_html__( 'Use the options below to customize your theme!', 'sento' ),
			'priority'    => 2,
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'General Settings', 'sento' ),
			'priority' => 10,
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'Homepage', 'sento' ),
			'priority' => 20,
			'panel'    => $prefix_name . 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'Homepage (Featured)', 'sento' ),
			'priority' => 30,
			'panel'    => $prefix_name . 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'Social Media', 'sento' ),
			'priority' => 60,
			'panel'    => $prefix_name . 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'Upgrade (10% off)', 'sento' ),
			'priority' => 80,
			'panel'    => $prefix_name . 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Logo Settings', 'sento' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_raw(
			...
			array(
				'label'           => esc_html__( 'Since WordPress v4.5 you can now add a site logo using the native WordPress options. To add a site logo go the "Site Identitiy" settings on the main customizer screen.', 'sento' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Page Structure', 'sento' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_generalsettings',
				'label'			  => esc_html__( 'Page Layout', 'sento' ),
				'description'	  => esc_html__( 'Select page layout. This will only be applied to published Pages.', 'sento' ),
				'choices'		  => array(
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_generalsettings',
			'type'			  => 'select',
			'label'			  => esc_html__( 'Select a Sidebar', 'sento' ),
			'description'	  => esc_html__( 'Choose a sidebar to use with the page layout.', 'sento' ),
			'choices'		  => thinkup_customizer_select_array_sidebar(),
// DISABLED			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
				'label'           => esc_html__( 'Enable Fixed Layout', 'sento' ),
				'description'	  => esc_html__( '(i.e. Disable responsive layout)', 'sento' ),
				'choices'		  => array(
					'1'      => __( 'On', 'sento' ),
					'off'    => __( 'Off', 'sento' ),
				),
	...
	// Add Enable Boxed Layout Control
	$wp_customize->add_setting(
		$prefix_name . 'thinkup_redux_variables[thinkup_general_boxlayout]',
		array(
			'type'                 => 'option',
			'capability'           => 'edit_theme_options',
			'theme_supports'       => '',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				'settings'        => $prefix_name . 'thinkup_redux_variables[thinkup_general_boxlayout]',
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
				'label'           => esc_html__( 'Enable Boxed Layout', 'sento' ),
				'description'	  => esc_html__( 'Switch on to enable boxed layout.', 'sento' ),
				'choices'		  => array(
					'1'      => __( 'On', 'sento' ),
					'off'    => __( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Backup Theme Options', 'sento' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
				'label'           => esc_html__( 'Backup Theme Options', 'sento' ),
				'description'	  => esc_html__( 'Switch on to backup your theme options settings each time the customizer is updated and saved. If enabled then a new page called "ThinkUp Created Content Backup" will be created where the option values can be found.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
				'active_callback' => '',
			)
		)
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Control Homepage Layout', 'sento' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
				'label'			  => esc_html__( 'Homepage Layout', 'sento' ),
				'description'	  => esc_html__( 'Select page layout. This will only be applied to static homepages (front page) and not to homepage blogs.', 'sento' ),
				'choices'		  => array(
					'option1' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option01.png',
					'option2' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option02.png',
					'option3' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option03.png',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'select',
			'label'			  => esc_html__( 'Select a Sidebar', 'sento' ),
			'description'	  => esc_html__( 'Choose a sidebar to use with the layout.', 'sento' ),
			'choices'		  => thinkup_customizer_select_array_sidebar(),
// DISABLED			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
				'label'           => esc_html__( 'Homepage Slider', 'sento' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'radio',
			'label'			  => esc_html__( 'Choose Homepage Slider', 'sento' ),
			'description'	  => esc_html__( 'Switch on to enable home page slider.', 'sento' ),
			'choices'		  => array(
				'option4' => esc_html__( 'Image Slider', 'sento' ),
				'option3' => esc_html__( 'Disable', 'sento' ),
			),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_raw(
			...
			array(
				'label'           => esc_html__( 'Slide 1', 'sento' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			array(
				...
				'label'	          => '',
				'description'	  => esc_html__( 'Image', 'sento' ),
// DISABLED				'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'text',
			'label'			  => '',
			'description'	  => esc_html__( 'Title', 'sento' ),
// DISABLED			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'text',
			'label'			  => '',
			'description'	  => esc_html__( 'Description', 'sento' ),
// DISABLED			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'dropdown-pages',
			'label'			  => '',
			'description'	  => esc_html__( 'URL', 'sento' ),
// DISABLED			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_raw(
			...
			array(
				'label'           => esc_html__( 'Slide 2', 'sento' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
...
// DISABLED			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_raw(
			...
			array(
				'label'           => esc_html__( 'Slide 3', 'sento' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
				'label'           => esc_html__( 'Enable Full-Width Slider', 'sento' ),
				'description'	  => esc_html__( 'Switch on to enable full-width slider.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
// DISABLED				'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'text',
			'label'			  => esc_html__( 'Slider Height (Max)', 'sento' ),
			'description'	  => esc_html__( 'Specify the maximum slider height (px).', 'sento' ),
// DISABLED			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
				'label'           => esc_html__( 'Call To Action - Intro', 'sento' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Message', 'sento' ),
			'description'	  => esc_html__( 'Check to enable intro on home page.', 'sento' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'text',
			'description'	  => wp_kses_post( __( 'Enter a <strong>title</strong> message.<br /><br />This will be one of the first messages your visitors see. Use this to get their attention.', 'sento' ) ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'text',
			'description'	  => wp_kses_post( __( 'Enter a <strong>teaser</strong> message.<br /><br />Use this to provide more details about what you offer.', 'sento' ) ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'text',
			'label'	          => esc_html__( 'Button - Text', 'sento' ),
			'description'	  => esc_html__( 'Specify a text for button 1.', 'sento' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'radio',
			'label'			  => esc_html__( 'Button - Link', 'sento' ),
			'description'	  => esc_html__( 'Specify whether the action button should link to a page on your site, out to external webpage or disable the link altogether.', 'sento' ),
			'choices'		  => array(
				'option1' => esc_html__( 'Link to a Page', 'sento' ),
				'option2' => esc_html__( 'Specify Custom link', 'sento' ),
				'option3' => esc_html__( 'Disable Link', 'sento' ),
			),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'dropdown-pages',
			'label'			  => esc_html__( 'Button - Link to a page', 'sento' ),
			'description'	  => esc_html__( 'Select a target page for action button link.', 'sento' ),
// DISABLED			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);	
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'text',
			'label'			  => esc_html__( 'Button - Custom link', 'sento' ),
			'description'	  => esc_html__( 'Input a custom url for the action button link. Add http:// if linking to an external webpage.', 'sento' ),
// DISABLED			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Display Pre-Designed Homepage', 'sento' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
				'label'           => esc_html__( 'Enable Pre-Made Homepage', 'sento' ),
				'description'	  => esc_html__( 'switch on to enable pre-designed homepage layout.', 'sento' ),
				'choices'		  => array(
					'1'      => __( 'On', 'sento' ),
					'off'    => __( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		new WP_Customize_Media_Control(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
				'label'	          => esc_html__( 'Content Area 1', 'sento' ),
				'description'	  => esc_html__( 'Add an image for the section background.', 'sento' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Add a title to the section.', 'sento' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			  => 'textarea',
			'description'	  => esc_html__( 'Add some text to featured section 1.', 'sento' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			=> 'dropdown-pages',
			'label'			=> esc_html__( 'Link to a page', 'sento' ),
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Media_Control(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
				'label'	          => esc_html__( 'Content Area 2', 'sento' ),
				'description'	  => esc_html__( 'Add an image for the section background.', 'sento' ),
				'active_callback' => '',
			)
		)
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			  => 'textarea',
			'description'	  => esc_html__( 'Add some text to featured section 2.', 'sento' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Media_Control(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
				'label'	          => esc_html__( 'Content Area 3', 'sento' ),
				'description'	  => esc_html__( 'Add an image for the section background.', 'sento' ),
				'active_callback' => '',
			)
		)
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			  => 'textarea',
			'description'	  => esc_html__( 'Add some text to featured section 3.', 'sento' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'label'           => esc_html__( 'Control Pre-Header Content', 'sento' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'         => $prefix_name . 'thinkup_customizer_section_header',
			'type'			  => 'radio',
			'label'			  => esc_html__( 'Choose Pre Header Style', 'sento' ),
			'description'	  => esc_html__( 'Specify the pre header style.', 'sento' ),
			'choices'		  => array(
				'option1' => esc_html__( 'Style 1 (Dark)', 'sento' ),
				'option2' => esc_html__( 'Style 2 (Light)', 'sento' ),
			),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_header',
				'label'           => esc_html__( 'Enable Search (Pre Header)', 'sento' ),
				'description'	  => esc_html__( 'Switch on to enable header search.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_header',
				'label'           => esc_html__( 'Control Header Content', 'sento' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_header',
				'label'           => esc_html__( 'Enable Search (Main Header)', 'sento' ),
				'description'	  => esc_html__( 'Switch on to enable header search.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Control Footer Content', 'sento' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_footer',
				'label'			  => esc_html__( 'Footer Widgets Layout', 'sento' ),
				'description'	  => esc_html__( 'Select footer layout. Take complete control of the footer content by adding widgets.', 'sento' ),
				'choices'		  => array(
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_footer',
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Disable Footer Widgets', 'sento' ),
			'description'	  => esc_html__( 'Check to disable footer widgets.', 'sento' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Social Media Control', 'sento' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Enable Social Media Links (Pre Header)', 'sento' ),
				'description'	  => esc_html__( 'Switch on to enable links to social media pages.', 'sento' ),
				'choices'		  => array(
					'1'      => __( 'On', 'sento' ),
					'off'    => __( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Enable Social Media Links (Main Header)', 'sento' ),
				'description'	  => esc_html__( 'Switch on to enable links to social media pages.', 'sento' ),
				'choices'		  => array(
					'1'      => __( 'On', 'sento' ),
					'off'    => __( 'Off', 'sento' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Social Media Content', 'sento' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => wp_kses_post( __( 'Add a message here. E.g. &#34;Follow Us&#34;.<br />(Only shown in header)', 'sento' ) ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Facebook', 'sento' ),
				'description'	  => esc_html__( 'Enable link to Facebook profile.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your Facebook page.', 'sento' ),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'sento' ),
			'description'	  => esc_html__( 'Check to use custom Facebook icon', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'description'	  => esc_html__( 'Add a link to the image or upload one from your desktop. The image will be resized.', 'sento' ),
				'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
			)
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Twitter', 'sento' ),
				'description'	  => esc_html__( 'Enable link to Twitter profile.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your Twitter page.', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'sento' ),
			'description'	  => esc_html__( 'Check to use custom Twitter icon', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Google+', 'sento' ),
				'description'	  => esc_html__( 'Enable link to Google+ profile.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your Google+ page.', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'sento' ),
			'description'	  => esc_html__( 'Check to use custom Google+ icon', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'LinkedIn', 'sento' ),
				'description'	  => esc_html__( 'Enable link to LinkedIn profile.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your LinkedIn page.', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'sento' ),
			'description'	  => esc_html__( 'Check to use custom LinkedIn icon', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Flickr', 'sento' ),
				'description'	  => esc_html__( 'Enable link to Flickr profile.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your Flickr page.', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'sento' ),
			'description'	  => esc_html__( 'Check to use custom Flickr icon', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Pinterest', 'sento' ),
				'description'	  => esc_html__( 'Enable link to Pinterest profile.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Use Custom Pinterest Icon', 'sento' ),
			'description'	  => esc_html__( 'Check to use custom Pinterest icon', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'YouTube', 'sento' ),
				'description'	  => esc_html__( 'Enable link to YouTube profile.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'     => esc_html__( 'Input the url to your YouTube page.', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'sento' ),
			'description'	  => esc_html__( 'Check to use custom YouTube icon', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'RSS', 'sento' ),
				'description'	  => esc_html__( 'Enable link to RSS profile.', 'sento' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'sento' ),
					'off'    => esc_html__( 'Off', 'sento' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'     => esc_html__( 'Input the url to your RSS feed.', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'sento' ),
			'description'	  => esc_html__( 'Use Custom RSS Icon', 'sento' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Control Blog (Archive) Pages', 'sento' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_blog',
				'label'			  => esc_html__( 'Blog Layout', 'sento' ),
				'description'	  => esc_html__( 'Select blog page layout. Only applied to the main blog page and not individual posts.', 'sento' ),
				'choices'		  => array(
					'option1' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option01.png',
					'option2' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option02.png',
					'option3' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option03.png',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'select',
			'label'			  => esc_html__( 'Select a Sidebar', 'sento' ),
			'description'	  => esc_html__( 'Note: Sidebars will not be applied to homepage Blog. Control sidebars on the homepage from the &#39;Home Settings&#39; option.', 'sento' ),
			'choices'		  => thinkup_customizer_select_array_sidebar(),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_blog',
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Blog Links - Lightbox', 'sento' ),
			'description'	  => esc_html__( 'Check to show lightbox link', 'sento' ),
			'active_callback' => '',
		)
	);
	$wp_customize->add_setting(
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_blog',
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Blog Links - Post', 'sento' ),
			'description'	  => esc_html__( 'Check to show post link', 'sento' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> $prefix_name . 'thinkup_customizer_section_blog',
			'type'			=> 'radio',
			'label'			=> esc_html__( 'Post Content', 'sento' ),
			'description'	=> wp_kses_post( __( 'Control how much content you want to show from each post on the main blog page. Remember to control the full article content by using the WordPress <a href="http://en.support.wordpress.com/splitting-content/more-tag/">more</a> tag in your post.', 'sento' ) ),
			'choices'		=> array(
				'option1' => esc_html__( 'Show excerpt', 'sento' ),
				'option2' => esc_html__( 'Show full article', 'sento' ),
				'option3' => esc_html__( 'Hide article', 'sento' ),
			)
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_blog',
				'label'           => esc_html__( 'Control Single Post Page', 'sento' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_blog',
				'label'			  => esc_html__( 'Post Layout', 'sento' ),
				'description'	  => esc_html__( 'Select blog page layout. This will only be applied to individual posts and not the main blog page.', 'sento' ),
				'choices'		  => array(
					'option1' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option01.png',
					'option2' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option02.png',
					'option3' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option03.png',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_upgrade_inner(
			...
			array(
				...
				'upgrade_url'     => 'https://www.thinkupthemes.com/themes/sento/',
				'price_discount'  => esc_html__( 'Upgrade for $31 (10% off)', 'sento' ),
				'price_normal'	  => esc_html__( 'Normally $35. Use coupon at checkout.', 'sento' ),
				'coupon'	      => esc_html__( 'sento31', 'sento' ),
				'button'	      => esc_html__( 'Upgrade Now', 'sento' ),
				'title_main'	  => esc_html__( 'So&hellip; Why upgrade?', 'sento' ),
				'title_secondary' => esc_html__( 'We&#39;re glad you asked! Here&#39;s just some of the amazing features you&#39;ll get when you upgrade&hellip;', 'sento' ),
				'images'		  => array(
