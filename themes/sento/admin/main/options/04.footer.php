...
function thinkup_input_footerw1() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'sento') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 1.', 'sento') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'sento' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'sento') . '</a>',
			'</div>';
	};
	echo	'</div>';
}
...
function thinkup_input_footerw2() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'sento') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 2.', 'sento') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'sento' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'sento') . '</a>',
			'</div>';
	};
	echo	'</div>';
...
function thinkup_input_footerw3() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'sento') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 3.', 'sento') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'sento' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'sento') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw4() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'sento') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 4.', 'sento') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'sento' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'sento') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw5() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'sento') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 5.', 'sento') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'sento' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'sento') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_footerw6() {
	...
	echo	'<h3 class="widget-title">' . esc_html__( 'Please Add Widgets', 'sento') . '</h3>',
			'<div class="error-icon">',
			'<p>' . esc_html__( 'Remove this message by adding widgets to Footer Widget Area 6.', 'sento') . '</p>',
			'<a href="' . esc_url( admin_url( 'widgets.php' ) ) . '" title="' . esc_attr__( 'No Widgets Selected', 'sento' ) . '">' . esc_html__( 'Click here to go to Widget area.', 'sento') . '</a>',
			'</div>';
	};	
	echo	'</div>';
...
function thinkup_input_copyright() {
	...
	printf( esc_html__( 'Theme by %1$s. Powered by %2$s.', 'sento' ), '<a href="https://www.thinkupthemes.com/" target="_blank">Think Up Themes Ltd</a>', '<a href="https://www.wordpress.org/" target="_blank">WordPress</a>' ); 
}
